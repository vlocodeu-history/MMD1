# dc007_body_holes_repo.py — psycopg2-safe JSONB writes + optional design_id + public schema
...
TABLE  = "public.dc007_body_holes_calcs"
    ...
    row = conn.execute(text("""
        select exists (
          ...
          where table_schema = 'public'
            and table_name   = 'dc007_body_holes_calcs'
