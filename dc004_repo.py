# dc004_repo.py — Supabase client version (optional design_id, public schema)
...
TABLE  = "dc004_calcs"   # bare name; we set schema("public") via client
ENTITY = "dc004"

print("[dc004_repo] loaded (Supabase) from:", __file__)
...
def _probe_design_id() -> bool:
    ...
    try:
        ...
        if _is_undefined_column(e):
            ...
            # On unrelated errors, default to True so real issues surface.
            _HAS_DESIGN_ID = True
    return _HAS_DESIGN_ID
...
def update_dc004_calc(
    ...
    *,
    ...
    sets: Dict[str, Any] = {}
    if name is not None:
        sets["name"] = (name or "DC004").strip() or "DC004"
